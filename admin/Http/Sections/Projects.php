...
class Projects extends Section implements Initializable
{
    ...
    public function onEdit($id)
    {
       ...
       ->addBody([
        ('<div class="alert alert-danger mb-0 m-3"><i class="fa fa-fw fa-info-circle"></i>Перед сохранением проверьте все поля! Проект не будет отображаться без главного изображения!</div>')
