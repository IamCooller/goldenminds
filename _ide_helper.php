 ...
 * Generated for Laravel 6.0.0 on 2022-03-22.
 *
...
namespace Laratrust { 
    ...
    class LaratrustFacade {
        ...
        {
            return \Laratrust\Laratrust::isAbleTo($permission, $team, $requireAll);
        }
        ...
        {
            return \Laratrust\Laratrust::isAbleToAndOwns($permission, $thing, $options);
        }
