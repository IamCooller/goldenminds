...
$(function () {
  ...
  var swiper = new Swiper('.slaider__body', {
    loop: true,
    //slidesPerView: 3,
    spaceBetween: 30,
    navigation: {
  ...
  var guidanceDirections = new Swiper('.guidanceDirections-gallery', {
    loop: true,
    spaceBetween: 30,
    navigation: {
      nextEl: '.reght-buttons__button-next',
  ...
  var departamentsList = new Swiper('.departaments__list', {
    loop: true,
    spaceBetween: 30,
    navigation: {
      nextEl: '.reght-buttons__button-next',
  ...
  var projectsSingle = new Swiper('.projectsSingle__gallery_list', {
    loop: true,
    spaceBetween: 15,
    navigation: {
      nextEl: '.reght-buttons__button-next',
  ...
  var projectsDone = new Swiper('.projectsDone__list-gallery', {
    loop: true,
    spaceBetween: 30,
    breakpoints: {
      320: {
  ...
  var tendersMoreList = new Swiper('.tendersMore__list', {
    loop: true,
    spaceBetween: 15,
    breakpoints: {
      320: {
  ...
  var PressCenterGallery = new Swiper('.PressCenter__gallery', {
    loop: true,
    navigation: {
      nextEl: '.reght-buttons__button-next',
      prevEl: '.reght-buttons__button-prev'
  ...
  var PressCenterMoreList = new Swiper('.PressCenterMore__list', {
    loop: true,
    navigation: {
...
$(document).mouseup(function (e) {
  var container = $(".labgvidg-header__dropdown");
...
if (voice == "yes") {
  var _artyom = new Artyom();

  _artyom.initialize({
    lang: "ru-RU",
    // A lot of languages are supported. Read the docs !
    continuous: false,
    // Artyom will listen forever
    listen: true,
    // Start recognizing
