                        ...
                        <div class="thumbnail">
                            ...
                            <div class="file-actions">
                                ...
                                <input type="text" class="form-control form-control-sm mb-2 tit{{ $show_title ? '' : ' hidden' }}"
                                       data-id="title"
                                       data-toggle="tooltip"
                                       data-original-title="Ссылка"
                                       placeholder="Ссылка"
                                />

                                <textarea class="form-control form-control-sm noresize desc hidden{{ $show_description ? '' : ' hidden' }}"
                                          data-id="description"
                                          rows="3"
                                          data-toggle="tooltip"
                    ...
                    <div class="fileThumbnail">
                        <div class="thumbnail">
                            ...
                            <div class="file-actions">
                                ...
                                <textarea
                                        class="form-control form-control-sm noresize desc hidden{{ $show_description ? '' : ' hidden' }}"
                                        data-id="description"
                                        rows="3"
                                        {{ $readonly ? 'disabled' : '' }}
                                        data-toggle="tooltip"
